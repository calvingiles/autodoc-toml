...
### Fixed
- Fixed create-release workflow condition bug where boolean return values were compared as strings
- Release creation now properly triggers when checking if release exists
